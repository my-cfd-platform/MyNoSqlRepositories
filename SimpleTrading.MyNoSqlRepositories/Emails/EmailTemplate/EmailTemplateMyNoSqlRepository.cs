...
namespace SimpleTrading.MyNoSqlRepositories.Emails.EmailTemplate
{
    public class EmailTemplatesMyNoSqlRepository : IEmailTemplatesRepository
    {
        ...
        public async Task SaveAsync(string brandId, EmailTypes emailType, Languages language, string templateId)
        {
            var entity = EmailTemplatesMyNoSqlEntity.Create(brandId, emailType, language, templateId);
